...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'oneup_uploader.orphanage.gallery' => 'getOneupUploader_Orphanage_GalleryService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'mHspWV)l0:QP', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7e1541261e9027d13bfc686bc259de7580efdb0eeb3c289f667adf3158813acf');
    ...
    protected function getOneupUploader_Controller_GalleryService()
    {
        ...
        return $this->services['oneup_uploader.controller.gallery'] = $this->scopedServices['request']['oneup_uploader.controller.gallery'] = new \Oneup\UploaderBundle\Controller\DropzoneController($this, $this->get('oneup_uploader.orphanage.gallery'), $this->get('oneup_uploader.error_handler.dropzone'), array('frontend' => 'dropzone', 'use_orphanage' => true, 'custom_frontend' => array('name' => NULL, 'class' => NULL), 'storage' => array('service' => NULL, 'type' => 'filesystem', 'filesystem' => NULL, 'directory' => ($this->targetDirs[2].'/../web/uploads/gallery'), 'stream_wrapper' => NULL, 'sync_buffer_size' => '100K'), 'route_prefix' => '', 'allowed_mimetypes' => array(), 'disallowed_mimetypes' => array(), 'error_handler' => NULL, 'max_size' => 9223372036854775807, 'enable_progress' => false, 'enable_cancelation' => false, 'namer' => 'oneup_uploader.namer.uniqid'), 'gallery');
    }
    ...
    /**
     * Gets the 'oneup_uploader.orphanage.gallery' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Oneup\UploaderBundle\Uploader\Storage\FilesystemOrphanageStorage A Oneup\UploaderBundle\Uploader\Storage\FilesystemOrphanageStorage instance.
     */
    protected function getOneupUploader_Orphanage_GalleryService()
    {
        return $this->services['oneup_uploader.orphanage.gallery'] = new \Oneup\UploaderBundle\Uploader\Storage\FilesystemOrphanageStorage($this->get('oneup_uploader.storage.gallery'), $this->get('session'), $this->get('oneup_uploader.chunks_storage'), array('maxage' => 86400, 'directory' => (__DIR__.'/uploader/orphanage')), 'gallery');
    }
    ...
    {
        return $this->services['oneup_uploader.orphanage_manager'] = new \Oneup\UploaderBundle\Uploader\Orphanage\OrphanageManager($this, array('maxage' => 86400, 'directory' => (__DIR__.'/uploader/orphanage')));
    }
    ...
    {
        return $this->services['oneup_uploader.templating.uploader_helper'] = new \Oneup\UploaderBundle\Templating\Helper\UploaderHelper($this->get('router'), array('gallery' => 10485760));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('4367415d6ed480a65fdd567c38d5aa02bae2a14f');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5659fd953941d7.83397991')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_user' => 'root',
            'database_password' => 'mHspWV)l0:QP',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '4367415d6ed480a65fdd567c38d5aa02bae2a14f',
            'locale' => 'en',
            ...
            'kernel.secret' => '4367415d6ed480a65fdd567c38d5aa02bae2a14f',
